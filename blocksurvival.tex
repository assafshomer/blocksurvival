...
Motivated by the work done in \cite{Selfish} we are interested in finding out if and when the block-hiding strategy gives the miner a higher probability of success in mining blocks, compared to the standard strategy outlined in the bitcoin protocol. 
